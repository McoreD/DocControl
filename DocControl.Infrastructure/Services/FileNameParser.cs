...
public sealed class FileNameParser
{
    ...
    public bool TryParse(string fileName, out ParsedFileName? parsed, out string reason)
    {
        parsed = null;
        reason = string.Empty;
        ...
        if (config.EnableLevel4)
        {
            ...
            parsed = new ParsedFileName(new CodeSeriesKey { Level1 = level1, Level2 = level2, Level3 = level3, Level4 = level4 }, num, freeText, ext);
            return true;
        }
        else
        {
            ...
            parsed = new ParsedFileName(new CodeSeriesKey { Level1 = level1, Level2 = level2, Level3 = level3 }, num, freeText, ext);
            return true;
        }
    }
